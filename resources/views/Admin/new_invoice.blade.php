                        ...
                        <div class="form-row">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select id="inputState" name="item" class="form-control">
                                        ...
                                        <?php
                                            ...
                                            if ($row->stock > 1 && !in_array($row->category, $added_categories)) {
                                                echo '<option>' . $row->category . '</option>';
                                                array_push($added_categories, $row->category);
                                            }
                                            }
                                        ?>
                                      </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <select id="product-dropdown" name="name" class="form-control">
                                        <option selected disabled>Choose...</option>
                                        @foreach($products as $row)
                                          @if($row->stock > 1)
                                            <option value="{{ $row->unit_price }}" data-category="{{ $row->category }}">{{ $row->name }}</option>
                                          @endif
                                        @endforeach
                                      </select>
                                    </div>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input class="form-control py-4" name="unit_price" type="text" id="price-input" readonly />
                                    </div>
                                  </div>
...
<script>
  ...
  const productSelect = document.getElementById('product-dropdown');
