                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" name="code" type="number" placeholder="" required/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" name="stock" type="number" placeholder="0" required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" name="unit_price" type="number" placeholder="0" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputLastName">Sale Price(perUnit)</label>
                                        <input class="form-control py-4" name="sale_price" type="number" placeholder="0" required/>
                                    </div>
                                </div>
