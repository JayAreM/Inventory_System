...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand"> <img src="{{ asset('frontend') }}/images/DICT_Logo1.jpg" width="40" height="40" class="rounded-circle me-2"> Inventory SYSTEM</a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="d-flex flex-column flex-shrink-0 p-2 bg-dark text-white" >
                                <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none" >
                                    &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <img src="{{ asset('frontend') }}/images/avatar.jpg" alt="Profile Avatar" width="100" height="100" margin-left="80px"  class="rounded-circle me-2" >
                                    
                                </a>
                               
                                <span class="fs-4" style="text-align: center">   @if (Auth::check())
                                    {{ Auth::user()->name }}
                                @else
                                    <div style="text-align: center;">[Guest]</div>
                                @endif
                                
                            </span>
                                

                                <span class="fs-4" style="text-align: center"> Regional Director</span>
